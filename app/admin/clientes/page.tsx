                  ...
                  <div className="relative bg-[#0a0a0a]/40 backdrop-blur-3xl border border-white/5 p-10 rounded-[3rem] hover:border-white/20 transition-all duration-500 h-full flex flex-col overflow-hidden">
                    ...
                    <div className="flex justify-between items-start mb-10">
                      ...
                      <div className="flex flex-col items-end gap-1">
                        ...
                        <span className="text-xs font-black text-gray-400 group-hover:text-[#FFD700] transition-colors">
                          #{client.cedula}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="mb-10">
                      <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#a855f7] mb-2 block">
                        Cliente
                      </span>
                      <h3 className="text-2xl font-black group-hover:bg-gradient-to-r group-hover:from-[#FFD700] group-hover:via-[#a855f7] group-hover:to-[#22d3ee] group-hover:bg-clip-text group-hover:text-transparent transition-all duration-500 leading-none">
                        {client.nombre}
                      </h3>
                    </div>
        ...
        {isAdding && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="bg-[#0a0a0a]/90 border border-white/10 w-full max-w-lg rounded-[2rem] rounded-[3.5rem] p-12 relative z-10 shadow-[0_0_100px_rgba(168,85,247,0.15)] overflow-hidden max-h-[90vh] overflow-y-auto custom-scrollbar"
            >
              ...
              <div className="mb-12 text-center relative">
                ...
                <h2 className="text-3xl text-4xl font-black font-[family-name:var(--font-orbitron)] mb-3 uppercase tracking-tighter leading-none">
                  Nuevo <br />
                  <span className="bg-gradient-to-r from-[#FFD700] via-[#a855f7] to-[#22d3ee] bg-clip-text text-transparent">
                    Cliente
                  </span>
                </h2>
                <p className="text-gray-500 text-[10px] font-black uppercase tracking-[0.3em] opacity-80 letter-spacing">
                  Registro de cliente
                </p>
              </div>
                ...
                <div className="pt-6">
                  ...
                  >
                    ...
                    <div className="relative flex items-center justify-center">
                      <span className="font-black text-black uppercase tracking-[0.2em] text-xs">
                        Guardar cliente
                      </span>
                    </div>
                  </button>
        ...
        {confirmDelete && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="bg-[#0a0a0a] border border-white/10 w-full max-w-md rounded-[2.5rem] p-8 relative z-10 shadow-2xl overflow-hidden"
            >
                ...
                <p className="text-gray-400 text-sm mb-8 leading-relaxed px-4">
                  {!isDoubleConfirm ? (
                    ...
                    <span className="text-gray-300">
                      ...
                      <span className="text-[10px] font-black tracking-[0.2em] text-[#FFD700] block mt-2">
...
function ClientInfo({
  ...
  return (
    <div className="group/info">
      <span className="text-[7px] font-black uppercase tracking-[0.4em] text-gray-600 mb-1.5 block group-hover/info:text-[#a855f7] transition-colors">
        {label}
      </span>
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative">
        <Icon
          className={`absolute left-5 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors ${error ? "text-red-400" : "text-gray-500 group-focus-within:text-[#a855f7]"}`}
        />
        <input
          {...props}
