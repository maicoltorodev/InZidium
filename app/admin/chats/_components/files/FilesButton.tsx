    ...
    return (
        <>
            <button
                ...
                title="Archivos"
                className="flex h-8 w-8 items-center justify-center rounded-xl border border-white/[0.06] bg-white/[0.03] text-gray-400 transition hover:border-[#FFD700]/30 hover:bg-[#FFD700]/[0.06] hover:text-[#FFD700]"
            >
