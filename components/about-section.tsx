      ...
      <div ref={containerRef} className="relative">
        ...
        <div className="mb-20 sm:mb-24 animate-on-mount" data-animation="fade-up" style={{ animationDelay: "0.2s" }}>
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <div className="glass-panel p-8 sm:p-10 rounded-3xl hover:bg-white/5 transition-all duration-300 group border border-white/10 hover:border-neon-purple/50 hover:shadow-[0_0_30px_rgba(168,85,247,0.2)] will-change-transform">
            ...
            <div className="glass-panel p-8 sm:p-10 rounded-3xl hover:bg-white/5 transition-all duration-300 group border border-white/10 hover:border-neon-cyan/50 hover:shadow-[0_0_30px_rgba(34,211,238,0.2)] will-change-transform">
