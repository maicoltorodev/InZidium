...
export function Footer() {
  ...
  return (
    <footer className="relative w-full">
      <div className="glass-panel bg-background/90 backdrop-blur-md shadow-2xl">
            ...
            <div className="flex flex-col items-center sm:items-start gap-3">
              ...
              <div className="flex flex-col items-center sm:items-start gap-2 mt-1">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-[12px] text-white/25 hover:text-white transition-colors duration-200"
                >
                  <Phone className="w-3 h-3" strokeWidth={1.75} />
                  <span>+57 320 248 3740</span>
                </a>
