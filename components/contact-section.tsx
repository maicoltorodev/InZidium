        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <button
              ...
              className="glass-panel p-8 sm:p-10 rounded-3xl group transition-all duration-300 hover:-translate-y-2 border border-white/10 hover:border-neon-purple/50 hover:shadow-[0_0_30px_rgba(168,85,247,0.2)] text-left relative"
            >
            ...
            <a
              ...
              className="glass-panel p-8 sm:p-10 rounded-3xl group transition-all duration-300 hover:-translate-y-2 border border-white/10 hover:border-neon-cyan/50 hover:shadow-[0_0_30px_rgba(34,211,238,0.2)]"
            >
              <div className="text-4xl mb-6 bg-white/10 w-16 h-16 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-white/5 shadow-inner">
