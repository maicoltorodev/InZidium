...
export function TabletOnboarding({
  project,
  clientName,
  savePatch,
  onReset,
  ...
  const chatInfo = useMemo(() => {
    ...
    const preview: string | undefined =
      lastAdmin?.nota && typeof lastAdmin.nota === "string"
        ? lastAdmin.nota.length > 80
          ? `${lastAdmin.nota.slice(0, 80)}…`
          : lastAdmin.nota
        : undefined;
      ...
      <AnimatePresence mode="wait">
        {view !== "hub" && (
          ...
          >
            ...
            {view === "chat" && <MensajesSection project={project} showToast={showToast} variant="tablet" />}
          </TabletSection>
        )}
      </AnimatePresence>
    </main>
