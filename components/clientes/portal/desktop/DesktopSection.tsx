...
export function DesktopSection({
  ...
  const iconRing =
    completion === "complete"
      ...
      : completion === "partial"
      ? "bg-[linear-gradient(135deg,rgba(232,121,249,0.14)_0%,rgba(168,85,247,0.14)_50%,rgba(96,165,250,0.14)_100%)] ring-1 ring-[#a855f7]/30 shadow-[0_0_50px_-14px_rgba(168,85,247,0.6)]"
