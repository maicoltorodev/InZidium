...
export function DesktopHub({
  ...
  // Filtramos secciones opcionales (ej: galería sólo aparece si el toggle
  // `galleryEnabled` está activo). HUB_SECTIONS sigue siendo la fuente de
  // verdad del orden — `isHubSectionVisible` solo decide visibilidad.
...
function LivePublishedCard({ liveUrl }: { liveUrl: string | null }) {
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-[2rem] border border-emerald-500/25 bg-[linear-gradient(135deg,rgba(16,185,129,0.08)_0%,rgba(16,185,129,0.04)_50%,rgba(34,211,238,0.06)_100%)] p-8 shadow-[0_0_40px_-14px_rgba(16,185,129,0.45)]"
    >
