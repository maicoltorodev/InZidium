    ...
    return (
        ...
        >
            <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    >
                        <Clock
                            ...
                            style={closed ? undefined : BRAND_ICON_STYLE}
                        />
                    </div>
                    <div className="min-w-0">
                        <p
                            className={`text-[13px] font-bold ${closed ? "text-white/40" : "text-white"}`}
                        >
                            {label}
                        </p>
                        {closed && (
                ...
                {/* Toggle Abierto/Cerrado — pill con dos estados para que se
                    entienda que es un switch del DÍA (no collapse de la UI). */}
                <div className="flex shrink-0 gap-1 rounded-full border border-white/[0.06] bg-black/20 p-0.5">
                    <button
                        type="button"
                        onClick={() => setClosed(false)}
                        className={`rounded-full px-2.5 py-1 text-[9px] font-black uppercase tracking-[0.2em] transition-colors ${
                            !closed
