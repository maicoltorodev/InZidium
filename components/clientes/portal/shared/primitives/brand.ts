...
// Fondo oscuro con tinte violeta + gradient fucsia -> purpura -> azul.
...
export const BRAND = {
  ...
  blue:       "#60a5fa", // blue-400 — bottom
} as const;

// Gradient diagonal completo: fucsia -> purpura -> azul
export const GRADIENT_BG = "bg-gradient-to-br from-[#e879f9] via-[#a855f7] to-[#60a5fa]";

// Gradient en texto
export const GRADIENT_TEXT =
  "bg-gradient-to-br from-[#e879f9] via-[#a855f7] to-[#60a5fa] bg-clip-text text-transparent";
